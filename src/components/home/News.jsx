              ...
              <div className="news__container">
                <div className={
                  ...
                  <div onClick={this.handledown1} className="news__title">
                    ...
                    <p>
                      {
                        til === "uz" ? x.Lcategory.name
                        : til === "ru" ? x.Lcategory.name_ru
                        : til === "oz" ? x.Lcategory.name_uz
                        : x.Lcategory.name_en
                      }
                ...
                <div className={
                  ...
                  <div onClick={this.handledown2} className="news__title">
                    ...
                    <p>
                      {
                        til === "uz" ? x.Fcategory.name
                        : til === "ru" ? x.Fcategory.name_ru
                        : til === "oz" ? x.Fcategory.name_uz
                        : x.Fcategory.name_en
                      }
                      < KeyboardArrowDownIcon />  
                    </p>
